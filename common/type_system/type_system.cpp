...
MethodInfo TypeSystem::override_method(Type* type,
    ...
    // Создаем копию существующего метода с обновленными полями
    ...
    // Преобразуем optional<string> в string
    if (docstring) {
