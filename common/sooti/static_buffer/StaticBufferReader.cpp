...
Object StaticBufferReader::read_value_at_ptr(TypeSystem* ts, void* ptr, Type* type) {
    if (!ptr || !type) return Object::make_null();
...
Object StaticBufferReader::read_primitive_at_ptr(void* ptr, ValueType* type) {
    ...
    switch (size) {
        case 1: return is_signed ? Object::make_integer(*(int8_t*)ptr) : Object::make_integer(*(uint8_t*)ptr);
        case 2: return is_signed ? Object::make_integer(*(int16_t*)ptr) : Object::make_integer(*(uint16_t*)ptr);
        case 4: {
            if (type->get_name() == "float") return Object::make_float(*(float*)ptr);
            return is_signed ? Object::make_integer(*(int32_t*)ptr) : Object::make_integer(*(uint32_t*)ptr);
        }
        case 8: {
            if (type->get_name() == "double") return Object::make_float(*(double*)ptr);
            return Object::make_integer(*(int64_t*)ptr);
        }
        default: return Object::make_null();
    }
}
...
Object StaticBufferReader::read_string_at_ptr(void* ptr) {
    if (!ptr) return Object::make_null();
