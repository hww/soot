 ...
 */
size_t StaticBufferFactory::write_from_type(TypeSystem* ts, StaticBuffer* dest,
 ...
 */
void StaticBufferFactory::write_array_field(TypeSystem* ts, StaticBuffer* dest, 
